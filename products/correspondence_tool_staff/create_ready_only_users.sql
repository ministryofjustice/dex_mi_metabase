...
GRANT SELECT ON cases_outcome_reasons, category_references, retention_schedules, tmp_partial_cases, data_requests, contacts,
  ...
  offender_data_request_volume_exclude_rejected_case_view, warehouse_case_report_for_london_disclosure_related, warehouse_case_report_for_offender_sar_related TO branson_read_access;
